...
public class OilServiceController {
    ...
    public ResponseEntity<?> deleteOilService(@PathVariable Long id) {
        ...
        return ResponseEntity.ok(
                new ApiResponse<>(true, "Oil service deleted successfully", null)
        );
    }
...
// =========================================================
    ...
    public ResponseEntity<ApiResponse<OilServiceResponseDTO>> getLatestOilService(
            @PathVariable Long vehicleId) {

        OilServiceResponseDTO response =
                oilServiceService.getLatestOilService(vehicleId);

        return ResponseEntity.ok(
                new ApiResponse<>(true, "Latest oil service fetched successfully", response)
        );
    }
    ...
    public ResponseEntity<?> getByVehiclePaginated(
        ...
        Page<OilServiceResponseDTO> result =
                oilServiceService.getByVehiclePaginated(vehicleId, page, size);
